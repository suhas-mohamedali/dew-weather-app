...
public class Wind implements WeatherDataType {
	...
	public String toString() {
		return "Wind [wmo=" + wmo + ", locationName=" + locationName + ", obervationTime=" + obervationTime
				+ ", wind_dir=" + wind_dir + ", wind_spd_kmh=" + wind_spd_kmh + ", wind_spd_kt=" + wind_spd_kt
				+ ", gust_kmh=" + gust_kmh + ", gust_kt=" + gust_kt + "]";
	}
